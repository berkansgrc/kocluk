...
function DenemeAnaliziContent() {
    ...
    return (
        <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
            <div>
                <h1 className="text-3xl font-bold tracking-tight font-headline">Deneme Sınavı Analizi</h1>
                <p className="text-muted-foreground">Deneme sınavı sonuçlarını yapay zeka ile analiz ederek güçlü ve zayıf yönlerini keşfet.</p>
            </div>
            <Separator />
